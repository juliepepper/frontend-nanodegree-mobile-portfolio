...
Started with a score of 29/100 on mobile and roughly the same on desktop.  Took suggestions of optimizing images and minifying files and looked to optimize through grunt.
 ...
 Created a Gruntfile.js and a package.json listing tasks and registering them.

 Ran grunt, found errors, worked through them and got a slightly higher pagespeed.

 Images: Did some manual manipulation of imagery through preview and Imageoptim to optimize further.

 CSS: Inlined it and added HTML media="print" to the external style sheet to link print styles.

 JS: Added async tags and put js at the bottom of HTML
...
1. Created src directory and ran grunt again to have dist directory mirror the files in src.
2. Modified views/js/main.js

Reduced sliding pizza elements generated, down from 200, to 24.

Addressed CSS Animation:
Added the CSS hack backface-visibility: hidden: to the mover class.
Applied TranslateX() and TranslateZ(0) to updatePositions function.
